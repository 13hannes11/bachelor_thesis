...
\todo[inline]{1st Relevance of the topic - why is configuration relevant, why is group configuration relevant - group configuration new field - why recommendations for it}
\todo[inline]{2nd Getting to the research question - issues with group decisions - forschungsfrage }
\todo[inline]{3rd what does this thesis create - To answer this question xyz will be created and evaluated}
